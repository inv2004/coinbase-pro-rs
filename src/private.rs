...
impl Private {
    fn get_sign(&self, timestamp: u64, uri: &str) -> String {
    ...
    fn get_headers(&self, uri: &str) -> HeaderMap {
        ...
        headers.insert("CB-ACCESS-SIGN", HeaderValue::from_str(&self.get_sign(timestamp, uri)).unwrap());
    ...
    pub fn get_accounts(&self) -> Result<Vec<Account>> {
        self._pub.get_sync("/accounts", self.get_headers("/accounts"))
    }
}
